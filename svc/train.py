...
def train_and_evaluate(
    ...
    for batch_idx, (
        ...
        nsff0 = nsff0.cuda(rank, non_blocking=True)
        ...
        with autocast(enabled=hps.train.fp16_run):
            ...
            ) = net_g(phone, phone_lengths, pitch, nsff0, spec, spec_lengths, spkid)
...
def evaluate(hps, generator, eval_loader, writer_eval):
    ...
    with torch.no_grad():
        ...
        y_hat, mask, *_ = generator.module.infer(
            phone, phone_lengths, pitch, nsff0, spkid, max_len=1000
        )
